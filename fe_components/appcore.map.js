...
define('utils', [
    ...
    var utils = {
        ...
        fetch: function(options) {
            ...
            utils.doAjax(options.url, options.data, options.method || 'get').done(function(res) {
...
define('resourceConfig', [
    ...
    var config = {
        'PUBLIC_CSS': [
            ...
            '/fe_components/bhtc/bhtc-datetimepicker/css/blue/bhtc-datetimepicker.css'
        ],
        'PUBLIC_BASE_JS': [
        ...
        'PUBLIC_NORMAL_JS': [
            '/fe_components/bh{{version}}.map.js',
...
define('boot', [
    ...
    var boot = {
        ...
        addTimestamp: function(url) {
            var staticTimestamp = utils.getConfig('STATIC_TIMESTAMP') || '10000';
            return url + '?t=' + staticTimestamp;
        },
