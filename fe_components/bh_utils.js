...
(function(BH_UTILS, undefined) {
    ...
    BH_UTILS.bhWindow = function(content, title, btns_def, params, callback) {
        ...
        //qiyu 2016-6-6 在window前面增加top.，用于解决在iframe中，弹窗仍然可以处于屏幕显示位置，需求人：汪维亮
    ...
    BH_UTILS.banBackSpace = function(e) {
        ...
        // var flag1 = (ev.keyCode == 8 && (t == "password" || t == "text" || t == "textarea" || t == "email" || t == "search" || t == "url" || t == "tel" || t == "number" || $(obj).hasClass('note-editable')) && (vReadOnly == true || vEnabled != true)) ? true : false;
        //
        // //当敲Backspace键时，事件源类型非密码或单行、多行文本的，则退格键失效
        // var flag2 = (ev.keyCode == 8 && t != "password" && t != "text" && t != "textarea" && t != "email" && t != "search" && t != "url" && t != "tel" && t != "number" && $(obj).hasClass('note-editable')) ? true : false;
        //
        // //判断
        // if (flag2) {
        //     return false;
        ...
        // }
        //
        // if (ev.keyCode == 8 && $(obj).hasClass('note-editable')) return false;
    };
