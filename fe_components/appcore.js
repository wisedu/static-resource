...
define('resourceConfig', [
    ...
    var config = {
        ...
        'IE_SHIV_CSS': ['/fe_components/jqwidget/blue/bh-ie.css']
    };
    return config;
});
define('ubaseUtils', [
    ...
    var ubaseUtils = {
        getModules: function () {
            ...
            _.each(modules, function (module) {
                ...
                module.originRoute = module.route;
                module.route = module.route.indexOf('/') > 0 ? module.route.substr(0, module.route.indexOf('/')) : module.route;
            });
            return modules;
        },
        ...
        getFirstModules: function () {
            ...
            return (appEntry || modules[0].originRoute).trim();
        },
...
define('boot', [
    ...
    var boot = {
                        ...
                        for (var i = 0; i < modules.length; i++) {
                            (function () {
                                ...
                                router.on('/' + route + '/?((w|.)*)', function (path) {
                                    if (currentRoute === modules[index - 3].originRoute) {
                                        return;
                                    }
                                    ...
                                    currentRoute = modules[index - 3].originRoute;
                                });
                            }());
                        }
        ...
        getUserEntry: function () {
            ...
            if (index == -1) {
                currentRoute = modules[0].originRoute;
